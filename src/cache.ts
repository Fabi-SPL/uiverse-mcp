 ...
 */
export async function ensureCache(cachePath: string): Promise<string> {
  if (cacheExists(cachePath)) return cachePath;
...
export async function refreshCache(
  cachePath: string
): Promise<{ updated: boolean; new_sha: string; previous_sha: string }> {
...
export async function getCurrentSha(cachePath: string): Promise<string> {
